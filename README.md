...
ה-Agent ירוץ בעברית ובאנגלית, ויבצע השוואה מדעית של לפחות 6 מודלים שונים בעברית ובאנגלית כדי לבחור את המודל הרלוונטי והנכון ביותר עבור האתר הנבדק — ויסביר מדוע נבחר המודל המסוים.
